...
dbLoadRecords("iocSoft.db", "IOC=PLC:txi_hxr_vac")
dbLoadRecords("save_restoreStatus.db", "P=PLC:txi_hxr_vac:")
dbLoadRecords("caPutLog.db", "IOC=${IOC}")

## TwinCat System Databse files ##
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=ASYN_PLC, PREFIX=PLC:txi_hxr_vac")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=ASYN_PLC, PREFIX=PLC:txi_hxr_vac")
...
save_restoreSet_status_prefix( "PLC:txi_hxr_vac:" )
